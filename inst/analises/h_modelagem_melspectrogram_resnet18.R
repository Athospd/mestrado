...
collate_fn <- function(batch) {
  ...
  melspec <- transform_mel_spectrogram(n_fft = 1024, win_length = 1024, hop_length = 256, f_max = 8000, n_mels = 128, power = 1)
...
optimizer <- torch::optim_adam(model$parameters, lr = 0.1, weight_decay = 0.001)
